...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 07, 2020 lúc 09:42 AM
...
CREATE TABLE `dong_gop` (
  `id` int(11) NOT NULL,
  `idHoKhau` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `dong_gop` (`id`, `idHoKhau`, `idSukien`, `sotien`, `thoigian`, `ghichu`) VALUES
(6, 'TQB003', 3, 50, '2020-11-26', 'Chị Linh vợ anh Dũng đóng 50k'),
(7, 'TQB002', 1, 100, '2020-11-26', 'anh Quân đóng 100k hôm trước'),
(8, 'TQB002', 2, 50, '2020-11-26', 'chị DUyên đóng 50k '),
(10, 'TQB001', 1, 200, '2020-11-28', '28/11 anh An đóng 200k'),
(11, 'TQB002', 1, 20, '2020-12-01', 'Chị Duyên nộp 20k');
...
CREATE TABLE `su_kien` (
  `id` int(11) NOT NULL,
  `tensukien` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `thoigian` date DEFAULT current_timestamp(),
  `batbuoc` int(11) DEFAULT NULL,
  `dongTheoHokhau` int(11) DEFAULT NULL,
  `dongTheoNhanKhau` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `su_kien` (`id`, `tensukien`, `thoigian`, `batbuoc`, `dongTheoHokhau`, `dongTheoNhanKhau`) VALUES
(1, 'Ủng hộ miền Trung thân yêu', '2020-11-25', 1, 200, 50),
(2, 'Ủng hộ người nghèo năm 2020', '2020-11-25', 0, 50, 0),
(3, 'Ủng hộ nạn nhân chất độc màu da cam', '2020-11-26', 0, 100, 100),
(4, 'Đóng quỹ phường làm khu vui chơi trẻ em', '2020-11-26', 1, 200, 200);
